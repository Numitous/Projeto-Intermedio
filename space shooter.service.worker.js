...
/** @type {string} */
const CACHE_VERSION = '1772138290|97067781';
/** @type {string} */
const CACHE_PREFIX = 'space shooter-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'space shooter.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["space shooter.html","space shooter.js","space shooter.offline.html","space shooter.icon.png","space shooter.apple-touch-icon.png","space shooter.audio.worklet.js","space shooter.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["space shooter.wasm","space shooter.pck"];
