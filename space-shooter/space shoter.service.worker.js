...
/** @type {string} */
const CACHE_VERSION = '1772134156|58339648';
/** @type {string} */
const CACHE_PREFIX = 'space shooter-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'space shoter.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["space shoter.html","space shoter.js","space shoter.offline.html","space shoter.icon.png","space shoter.apple-touch-icon.png","space shoter.audio.worklet.js","space shoter.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["space shoter.wasm","space shoter.pck"];
